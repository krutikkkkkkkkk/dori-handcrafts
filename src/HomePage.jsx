...
const testimonials = [
  ...
  },
  {
    name: "Dhruv",
    avatar:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiyTZELsW9Qag5l84uBtoes0z0pDCbCALeUAd-6HIDZA&s",
  ...
  },
  {
    name: "Krutik",
    avatar:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScSJLd5w25w403fBGB6IpH-DVEZnQ4tglEKP5JP1k72g&s",
...
=======
      <header className="bg-primary text-white py-8 shadow-md">
        <nav className="container px-16 mx-auto flex justify-between items-center">
          <a href="#" className="text-2xl font-bold">
            <img
              src="https://i.ibb.co/fYSqg3g/Dori-logo.png"
              style={{ width: "80px" }}
              alt="Dori"
            />
          </a>
...
>>>>>>> 6b6f2c39be6335347b18eb38d125c957baa8e504
            <a
              href="#"
              className="hidden lg:block bg-white text-primary px-4 py-1 rounded-lg hover:bg-gray-100"
            >
              Login
            </a>
        ...
        <ul
          id="mobile-menu"
          className="hidden flex flex-col space-y-2 mt-4 px-4 lg:hidden"
        >
          <li>
          ...
          <li>
            <input
              type="text"
              placeholder="Search..."
              className="block px-4 py-1 rounded-lg text-gray-900"
            />
          </li>
          <li>
            <a
              href="#"
              className="block bg-white text-primary px-4 py-1 rounded-lg hover:bg-gray-100"
            >
              Login
            </a>
          </li>
...
>>>>>>> 6b6f2c39be6335347b18eb38d125c957baa8e504
      ...
      <section className="AboutUs mx-auto container md:py-20 py-4">
        <div className="container mx-auto md:py-16 md:px-16 px-4 py-2 bg-accent flex justify-center items-center flex-col">
          <h1 className="text-4xl font-bold text-center text-primary md:mb-12 mb-2 md:py-5 py-2">
            Why we started this?
          </h1>
          <p className="text-center text-lg text-primary  w-10/12">
...
=======
      ...
      <section className="aunty mx-auto my-auto">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://i.ibb.co/p1FmbG9/Women-Empowerment.jpg')",
          }}
        >
          <div className="col w-full lg:w-1/2 md:mt-10 mt-4 lg:mt-20">
            <h6 className="text-xl md:text-2xl lg:text-3xl font-bold text-primary mb-6 md:mb-8 lg:mb-12">
            ...
            <p className="text-base md:text-lg lg:text-xl text-primary w-full md:w-10/12">
              Your every purchase matters because their craft at Dori Handcrafts
              is no longer called a household but a way of fueling their
              livelihood.
              <br />
              <br />
              Seeing our founder making macrame products as a hobby, to creating
              a memorable brand by empowering women artisans is a dream come
              true.
            </p>
          </div>
          <div className="col flex-1 w-full mt-8 lg:mt-0 lg:ml-10">
            <img
              ...
              src="https://i.ibb.co/dGX4xL1/Aunty.png"
              alt="Aunty"
            />
          </div>
        </div>
          ...
          <div className="flex items-center justify-center flex-wrap gap-8 text-center">
            <div className="border-2 border-white text-white p-6 rounded-2xl flex justify-between items-center flex-1">
              <div className="grp flex space-x-4 md:space-x-8 items-center justify-center">
                ...
                />
                <p className="text-lg md:text-[26px] text-start leading-6 md:leading-8">
                  Happy <br /> Customers
                </p>
              </div>
              <h2 className="text-3xl md:text-[3rem] font-bold font-count">
                100+
              </h2>
            </div>
      ...
      <section
        className="testimonials flex justify-center mx-auto h-auto md:h-[900px] bg-cover bg-bottom bg-no-repeat px-4"
        style={{
          backgroundImage: "url('https://i.ibb.co/7nWhpb4/Frame-16.jpg')",
        }}
      >
        <div className="container mx-auto py-16 md:py-20">
          ...
          <div className="flex flex-wrap justify-center md:px-14 py-10 gap-8 md:gap-10">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-none border border-primary text-primary py-4 rounded-2xl shadow-lg flex flex-col items-center w-full md:w-1/3 lg:w-1/4 h-auto md:h-[440px]"
              >
                <div className="flex items-center justify-between space-x-4 mb-4 w-full px-4">
                  <h3 className="text-lg">{testimonial.name}</h3>
                  <img
                    ...
                    className="w-12 h-12 rounded-full border-[1px] border-white object-cover"
                  />
                </div>
                <div className="testimonial-text h-auto md:h-[60%] border-x-0 border-y-2 border-primary flex text-center justify-center items-center text-white bg-primary opacity-60 px-4 py-6 md:py-0">
                  <p className="text-sm md:text-lg w-full md:w-[80%]">
                    {testimonial.text}
                  </p>
                </div>
                <div className="flex space-x-1 justify-start py-6 w-full px-4">
      ...
      <section className="footer bg-accent">
          ...
          <div className="container text-primary mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-20">
              ...
              <div className="flex justify-center lg:justify-start items-center">
                <img
                  src="https://i.ibb.co/RD1BmW0/dori-brown.png"
                  className="w-20"
                  alt="Dori"
                />
              </div>
        ...
        <div className="border-t border-gray-300 py-6 text-center">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4">
            ...
            <button className="mt-4 md:mt-0 text-brown-800 flex text-lg items-center">
              Back to Top{" "}
              <span className="px-4">
                <img src={UpArrow} alt="" className="h-[3rem] w-[3rems]" />
              </span>
            </button>
          </div>
        </div>
